...
- Answer: The default static position is 0 pixels away from the top and left side. When we applied the change, it moved 20 pixels from the top and left.
...
- Answer: Unlike position relative, when users scroll the page, the footer stays and remains inside of the view.
