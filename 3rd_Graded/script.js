function plotPoint(x0, y0, x, y) {
    ...
    point.style.left = (Number(x) - Number(x0) + 200 - 5) + 'px'; // subtract half the width of the point to center it by changing left css property
    point.style.bottom = (Number(y) - Number(y0) + 200 - 5) + 'px'; // subtract half the height of the point to center it by changing bottom css property
